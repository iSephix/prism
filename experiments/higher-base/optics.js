...
/* Isolated 0.3.4 simulator fork: identical optical channel for stable and PX codes. */
(function(root, factory) {
  if (typeof module === 'object' && module.exports) module.exports = factory(require('../../src/codec.js'),require('./codec.js'));
  else root.PrismXOptics = factory(root.Prism19Core,root.PrismX);
})(globalThis, function(stable,PX) {
  const Prism={colorAt:(code,x,y)=>code.format==='PX-1'?PX.colorAt(code,x,y):stable.colorAt(code,x,y)};
  'use strict';
